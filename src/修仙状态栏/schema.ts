export const Schema = z.object({
  主角: z
    .object({
      ...
      气血: z.preprocess(val => (val === null || val === undefined ? 100 : Number(val)), z.number()).prefault(100),
      气血上限: z.preprocess(val => (val === null || val === undefined ? 100 : Number(val)), z.number()).prefault(100),
      法力值: z.preprocess(val => (val === null || val === undefined ? 80 : Number(val)), z.number()).prefault(80),
      法力上限: z.preprocess(val => (val === null || val === undefined ? 100 : Number(val)), z.number()).prefault(100),
      善恶值: z
        .preprocess(val => (val === null || val === undefined ? 0 : Number(val)), z.number())
        .transform(v => _.clamp(v, -100, 100))
        .prefault(0),
      san值: z
        .preprocess(val => (val === null || val === undefined ? 80 : Number(val)), z.number())
      ...
      六维: z
        .object({
          力道: z
            .preprocess(val => (val === null || val === undefined ? 10 : Number(val)), z.number())
            .transform(v => _.clamp(v, 0, 100))
            .prefault(10),
          体魄: z
            .preprocess(val => (val === null || val === undefined ? 10 : Number(val)), z.number())
        ...
        .prefault({}),
      灵悟值: z.preprocess(val => (val === null || val === undefined ? 0 : Number(val)), z.number()).prefault(0),
      本源: z.string().prefault('剑'),
      灵根: z.string().prefault('金灵根'),
      灵石: z.preprocess(val => (val === null || val === undefined ? 0 : Number(val)), z.number()).prefault(0),
      ...
      背包: z
        .record(
          ...
          z
            .object({
              描述: z.string().prefault(''),
              数量: z.preprocess(val => (val === null || val === undefined ? 1 : Number(val)), z.number()).prefault(1),
              类型: z
                .enum([
                  '丹药',
                  '材料',
    ...
    .object({
      ...
      地图标记: z
        .record(
          ...
          z
            .object({
              x: z.preprocess(val => (val === null || val === undefined ? 50 : Number(val)), z.number()).prefault(50),
              y: z.preprocess(val => (val === null || val === undefined ? 50 : Number(val)), z.number()).prefault(50),
    ...
    z
      .object({
        ...
        _属性: z
          .object({
            力道: z
              .preprocess(v => (v === null || v === undefined ? 10 : Number(v)), z.number())
              .transform(v => _.clamp(v, 0, 100))
              .prefault(10),
            体魄: z
              .preprocess(v => (v === null || v === undefined ? 10 : Number(v)), z.number())
    ...
    .record(
      ...
      z
        .object({
          ...
          属性加成: z.string().prefault(''),
          已学习: z
            .preprocess(val => (val === null || val === undefined ? false : Boolean(val)), z.boolean())
            .prefault(false),
    ...
    .record(
      ...
      z
        .object({
          ...
          属性加成: z.string().prefault(''),
          已学习: z
            .preprocess(val => (val === null || val === undefined ? true : Boolean(val)), z.boolean())
            .prefault(true),
  ...
  当前秘境: z
    .object({
      在秘境中: z.boolean().prefault(false),
      名称: z.string().prefault(''),
      品阶: z.enum(['黄', '玄', '地', '天', '未知']).prefault('未知'),
      当前场景: z.string().prefault(''),
      场景描述: z.string().prefault(''),
      网格: z
        .preprocess(
          val => (Array.isArray(val) && val.length === 10 ? val : ['', '', '', '', '', '', '', '', '', '']),
          z.array(z.string()).length(10),
        )
        .prefault(['', '', '', '', '', '', '', '', '', '']),
      标记说明: z.record(z.string(), z.string()).prefault({}),
      剩余刻数: z.coerce.number().prefault(0),
      刻数上限: z.coerce.number().prefault(0),
      已得宝物: z.array(z.string()).prefault([]),
      已石化: z.boolean().prefault(false),
    })
    .prefault({}),
