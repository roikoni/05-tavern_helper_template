...
onMounted(async () => {
  ...
  const regionDescs: Record<string, string> = {
    '西漠':'沙海、魔道辖区与天渊污染线交错。白日晒死人，夜里沙下有东西学人说话；莫尔迦绿洲是少数仍有秩序的避难地',
    '中州':'人族文明核心，大虞皇朝与正道七宗勉强维持灯火。城墙内有律法与坊市，城墙外仍有难民、邪修、梦魇病例和夜行妖兽',
    '北冥':'极寒冰原与无尽海域。海雾常带来低语、失航船影和深海巨兽，玄冰城外的夜路极少有人走完',
    '南岭':'群山连绵，灵草灵矿丰盛，也滋养毒瘴、畸变灵植、药人试验和失控秘境。采药队出山时少一两个人并不稀奇',
    '东荒':'原始林海与古老山脉交错，妖族、人族城邦、猎妖者和怪物共同争食边境。许多旧路走到一半便会消失在树根下',
    ...
    '莫尔伽领地':'天渊裂谷以北三百里，古神莫尔迦自建的绿洲王国。修仙界未正式承认其政权，却默认这里是天渊污染缓冲区与难民庇护地；莫尔迦嘴上嫌弃人类麻烦，实际严禁战火、奴役、血祭与旧日崇拜入境',
    '玄冰城':'北冥唯一大城，建在冰山上。大虞最近一次派遣官员是一百二十年前',
    '天渊关口':'中州与西漠之间的关口，大虞名义疆界止于此。西行商队和逃亡者在此交汇',
    '北海渔港及渔村':'北海沿岸自治社区，没有法律没有税收。渔民自行推举长者裁决纠纷',
    '克茜拉的废弃渔村':'渔港以北约百里。古神克茜拉在此守潮灯，压制废村下方的旧日海梦与污染裂口',
